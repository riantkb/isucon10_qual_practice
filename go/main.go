...
func searchEstateNazotte(c echo.Context) error {
	...
	query := fmt.Sprintf(`SELECT id, name, description, thumbnail, address, latitude, longitude, rent, door_height, door_width, features, popularity FROM estate WHERE ST_Contains(ST_PolygonFromText(%s), coord) ORDER BY popularity_desc ASC, id ASC LIMIT ?`, coordinates.coordinatesToText())
